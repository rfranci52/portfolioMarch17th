// $("#myImg").html("<img src="images/glossy-patriots-logo-png-17.png>');
// var myImage = document.createElement("img");
// myImage.setAttribute("src", "https://www.freepnglogos.com/uploads/glossy-patriots-logo-png-17.png");
// document.getElementById("#div").append(myImage);


// var numberOptions = [12];
...
function question11() {
    ...
    img2.src = "images/glossy-patriots-logo-png-17.png";
...
function myfunct() {
    var question1 = {
        question: prompt("who are the 2004 champs (ANSWER MUST BE A ONE WORD ANSWER)"),
    ...
    if (question1.question.toLowerCase() === question1.answer_choices[0]) {
        ...
        // img2.src = "images/new_england_patriots_bob_schultz.png";
        // var src = document.getElementById("x");
...
// document.write("who are the 2004 champs",
//     question11()
...
// $("#y").click(myfunct())
// console.log($("#y").click(myfunct()))


// var question2 = {
//     question: prompt("who are the 2019 champs"),
//     answer_choices: ["the patriots", "the chargers", "the bengals", "glossy-patriots-logo-png-17.png"],

// }
// question = prompt("who are the champs")
// console.log(question1.question)
// console.log(question1.answer_choices[0])

// if (question11() === "the patriots") {
//     console.log("blah")
// }
// for (question1.question; question1.question = str.toLowerCase();)
if (question1.question.toLowerCase() === question1.answer_choices[0]) {
    question11()
    // var img2 = document.createElement("img");
